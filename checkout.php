...
<div class="container">
				...
				<div class="col-md-6 col-md-offset-3">
					<div class="billing-details">
						<h3 class="uppercase">Billing Details</h3>
							...
							<input name="company" class="form-control" placeholder="" value="<?php if(!empty($r['company'])){ echo $r['company']; }elseif(isset($company)){ echo $company; } ?>" type="text" required>
							<div class="clearfix space20"></div>
							<label>Address </label>
							...
							<div class="clearfix space20"></div>
							<input name="address2" class="form-control" placeholder="Apartment, suite, unit etc." value="<?php if(!empty($r['address2'])){ echo $r['address2']; }elseif(isset($address2)){ echo $address2; } ?>" type="text" required>
							<div class="clearfix space20"></div>
							<div class="row">
								<div class="col-md-4">
									<label>City </label>
			...
			<table class="table table-bordered extra-padding">
				<tbody>
					<tr>
						<th>Cart Subtotal</th>
						<td><span class="amount">INR <?php if (isset($_SESSION['cart'])) { echo $total; } ?>.00/-</span></td>
					</tr>
					<tr>
					...
					<tr>
						<th>Order Total</th>
						<td><strong><span class="amount">INR <?php if (isset($_SESSION['cart'])) {echo $total;} ?>.00/-</span></strong> </td>
					</tr>
				</tbody>
			</table>
			...
			<div class="payment-method">
				<div class="row">
						...
						<div class="col-md-4">
							<input name="payment" id="radio1" class="css-checkbox" type="radio" value="Cash On Delivery" required><span>Cash On Delivery</span>
			...
			<?php }else{?>
				<h2><?php echo "Please Add a product"; ?></h2>
			<?php } ?>
			</div>
		</div>		
</form>		
